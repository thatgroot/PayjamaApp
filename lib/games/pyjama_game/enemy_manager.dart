...
class EnemyManager extends Component with HasGameReference<PyjamaRunnerGame> {
  ...
  void onMount() {
    ...
    if (_data.isEmpty) {
      ...
      _data.addAll([
        EnemyData(
          image: game.images.fromCache('pyjama/AngryPig/balloon.png'),
        ...
        EnemyData(
          image: game.images.fromCache('pyjama/Bat/bird1.png'),
        ...
        EnemyData(
          image: game.images.fromCache('pyjama/Rino/bubble.png'),
          nFrames: 5,
          stepTime: 0.09,
        ...
        EnemyData(
          image: game.images.fromCache('pyjama/cushion1.png'),
          nFrames: 4,
          stepTime: 0.1,
