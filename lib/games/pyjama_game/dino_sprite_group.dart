...
class Dino extends SpriteAnimationGroupComponent<DinoAnimationStates>
    with CollisionCallbacks, HasGameReference<PyjamaRunnerGame> {
  ...
  void jump() {
    ...
    if (isOnGround) {
      speedY = -300;
      current = DinoAnimationStates.run;
      AudioManager.instance.playSfx('pyjama/jump14.wav');
    }
  }
  ...
  void hit() {
    isHit = true;
    AudioManager.instance.playSfx('pyjama/hurt7.wav');
